...
const listColumn = [
  ...
  { key: 'learningType', value: 'Hình thức học' },
...
const StudentOfficialTab = () => {
  ...
  const columns: ColumnDef<any, any>[] = [
    ...
    columnHelper.accessor('learningType', {
      header: () => <span>Hình thức học</span>,
      size: 1000,
    }),
...
export default StudentOfficialTab;
