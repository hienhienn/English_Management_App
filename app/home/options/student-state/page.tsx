...
const StudyGoal = () => {
  ...
  const getData = async () => {
    ...
    try {
      const res = await api.functional.student_state.findAll(connection, query);
      if (res.data) {
      ...
      <Popup open={openAdd} closeOnDocumentClick={false}>
        ...
        <AddOption
          ...
          addFunction={(data: any) =>
            api.functional.student_state.create(connection, data)
          }
        />
      </Popup>
      <Popup open={openUpdate} closeOnDocumentClick={false}>
        ...
        <AddOption
          updateFunction={(data: any) =>
            api.functional.student_state.update(connection, selected.id, data)
          }
