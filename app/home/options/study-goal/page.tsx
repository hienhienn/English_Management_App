...
const StudyGoal = () => {
  ...
  const getData = async () => {
    ...
    try {
      const res = await api.functional.study_goal.findAll(connection, query);
      if (res.data) {
      ...
      <Popup open={openAdd} closeOnDocumentClick={false}>
        ...
        <AddOption
          ...
          addFunction={(data: any) =>
            api.functional.study_goal.create(connection, data)
          }
        />
      </Popup>
      <Popup open={openUpdate} closeOnDocumentClick={false}>
        ...
        <AddOption
          updateFunction={(data: any) =>
            api.functional.study_goal.update(connection, selected.id, data)
          }
