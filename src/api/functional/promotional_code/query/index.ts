 ...
 * @module api.functional.promotional_code.query
...
/**
 * @controller PromotionalCodeController.getQuery
 * @path GET /promotional-code/query
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
...
export namespace getQuery {
  ...
  export const path = (query: getQuery.Query): string => {
    ...
    return `/promotional-code/query${encoded.length ? `?${encoded}` : ''}`;
  };
}
